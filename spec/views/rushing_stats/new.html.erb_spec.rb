...
describe "rushing_stats/new" do
  before(:each) do
    assign(:rushing_stat, stub_model(RushingStat,
      :name => "MyString",
      :rushing_att => 1,
      :rushing_yards => 1,
      :rushing_att_avg => 1.5,
  ...
  it "renders new rushing_stat form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => rushing_stats_path, :method => "post" do
